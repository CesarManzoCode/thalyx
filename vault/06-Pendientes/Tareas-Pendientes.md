...
- [ ] **Los verbos, por la pantalla.** Es la entrega siguiente de [[La-Pantalla]] y lo único que le falta para dejar de ser un dibujo y ser el sistema. `session::run` es un solo ciclo de seiscientas líneas que imprime conforme avanza; hace falta que una línea tecleada devuelva su respuesta en vez de imprimirla, y eso es una edición grande al código más ejercido del proyecto. **Deliberadamente no se hizo junto con los primeros pixeles**: si la máquina de Cesar arrancara en negro, no habría manera de saber cuál de los dos cambios fue.
