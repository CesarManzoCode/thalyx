...
- [ ] **Correr el acto 2a: arrancar desde una USB en la PC de Cesar.** Procedimiento entero en [[Arranque-en-Hierro]]. Responde firmware real, xHCI real, teclado real, `USB_STORAGE` real y el NVMe real listado por `discos`, **sin escribir un byte** en el disco interno. Ninguno de esos pasos se ha ejecutado.
