...
- [ ] **Bajarle peso a la instrucción de abstención del prompt** — el banco de la gama media **se abstuvo con el id dicho en claro**, que es el caso más fácil que tiene. Apunta al prompt y no al tamaño del modelo: la frase que enseña a abstenerse se añadió cuando la gramática no permitía lista vacía, y ahora puede estar pesando de más. **Tocar el prompt mueve los nueve casos a la vez**, así que no se toca sin volver a correr el banco antes y después, y sin correr también las otras gamas — o el cambio se atribuye a la gama equivocada. Ver [[Gamas-de-Modelo]].
- [ ] **Decidir qué hacer con un módulo mencionado y luego descartado** — el único caso del banco en que la gama media **actuó sobre algo que la persona había excluido**. No inventó un id: tomó uno que estaba en la conversación y había sido rechazado. La negación en una conversación es un problema de comprensión, no de gramática, y no se arregla restringiendo la salida. Falta decidir si es cosa del prompt, del ensamblado del transcript, o algo que simplemente se le pide a la gama alta. Ver [[Gamas-de-Modelo]].
