...
- [ ] **El instalador.** Es lo único que falta para que la ISO instale: particionar el disco (GPT), escribir la partición EFI con el kernel adentro, y formatear la otra como store. Las dos piezas caras ya están —el arranque sin gestor y el store que Thalyx escribe y subvolumina él mismo—; falta el acto que las junta y que decide qué disco. Ver [[Construccion-del-ISO]].
