...
| El cargador de BPF propio | `crates/thalyx-bpf`, `crates/thalyx-syscall` | ELF, BTF, forma de los mapas, CO-RE y las llamadas `bpf(2)`. El objeto va dentro del binario. **Carga y atacha en hardware**; falta una etapa 14 verde entera. Ver [[Cargador-BPF-Propio]] |
