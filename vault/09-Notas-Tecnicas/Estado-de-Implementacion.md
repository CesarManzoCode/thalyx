...
| Arranque sin gestor de arranque | `image/thalyx.config`, `image/Makefile` | `EFI_STUB` + initramfs dentro del kernel + línea de comandos compilada. **Probado el 2026-08-06**: un firmware UEFI arrancó Thalyx entera —`switch_root`, los siete montajes, los controladores, el LSM enganchado y la sesión— desde un medio con **un archivo**. Ver [[Construccion-del-ISO]] |
